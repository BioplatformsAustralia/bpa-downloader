...
bpa_dltool_slug = "bpa_1c06b8f8_20210813T0552"
bpa_username = "mtearle"
...
def check_for_api_key():
    ...
    api_key_message = """    Please set the CKAN_API_KEY environment variable.
    ...
    nix_instructions = """    To set the environment variable in Linux/MacOS/Unix, use
    ...
    win_instructions = """    On Microsoft Windows, within Powershell, use:
